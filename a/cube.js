  ...
  for (let x = -1; x <= 1; x++) {
    for (let y = -1; y <= 1; y++) {
      for (let z = -1; z <= 1; z++) {
        ...
        // --- Up center ---
        if (y === 1 && x === 0 && z === 0)
          addCenterSticker(cubelet, 2, 'U.png', 0);
        // --- Down center ---
        if (y === -1 && x === 0 && z === 0)
          addCenterSticker(cubelet, 3, 'D.png', 0);
        // --- Front center ---
        if (z === 1 && x === 0 && y === 0)
          addCenterSticker(cubelet, 4, 'F.png', 0);
        // --- Back center ---
        if (z === -1 && x === 0 && y === 0)
          addCenterSticker(cubelet, 5, 'B.png', 0);
        // --- Right center ---
        if (x === 1 && y === 0 && z === 0)
          addCenterSticker(cubelet, 0, 'R.png', 0);
        // --- Left center ---
        if (x === -1 && y === 0 && z === 0)
          addCenterSticker(cubelet, 1, 'L.png', 0);
        if ([x, y, z].filter((v) => v !== 0).length === 2) {
          // --- U* edges ---
          if (y === 1 && z === 1 && x === 0)
            addCenterSticker(cubelet, 2, 'CU.png', 0); // UF
          if (y === 1 && x === 1 && z === 0)
            addCenterSticker(cubelet, 2, 'CU.png', 90); // UR
          if (y === 1 && z === -1 && x === 0)
            addCenterSticker(cubelet, 2, 'CU.png', 180); // UB
          if (y === 1 && x === -1 && z === 0)
            addCenterSticker(cubelet, 2, 'CU.png', 270); // UL
          // --- D* edges ---
          if (y === -1 && z === 1 && x === 0)
            addCenterSticker(cubelet, 3, 'CD.png', 180); // DF
          if (y === -1 && x === 1 && z === 0)
            addCenterSticker(cubelet, 3, 'CD.png', 90); // DR
          if (y === -1 && z === -1 && x === 0)
            addCenterSticker(cubelet, 3, 'CD.png', 0); // DB
          if (y === -1 && x === -1 && z === 0)
            addCenterSticker(cubelet, 3, 'CD.png', 270); // DL
          // --- F* edges ---
          if (z === 1 && x === 1 && y === 0)
            addCenterSticker(cubelet, 4, 'CF.png', 90); // FR
          if (z === 1 && x === -1 && y === 0)
            addCenterSticker(cubelet, 4, 'CF.png', 270); // FL
          if (z === 1 && y === 1 && x === 0)
            addCenterSticker(cubelet, 4, 'CF.png', 180); // UF
          if (z === 1 && y === -1 && x === 0)
            addCenterSticker(cubelet, 4, 'CF.png', 0); // DF
          // --- B* edges ---
          if (z === -1 && x === 1 && y === 0)
            addCenterSticker(cubelet, 5, 'CB.png', 270); // BR
          if (z === -1 && x === -1 && y === 0)
            addCenterSticker(cubelet, 5, 'CB.png', 90); // BL
          if (z === -1 && y === 1 && x === 0)
            addCenterSticker(cubelet, 5, 'CB.png', 180); // UB
          if (z === -1 && y === -1 && x === 0)
            addCenterSticker(cubelet, 5, 'CB.png', 0); // DB
          // --- R* edges ---
          if (x === 1 && y === 1 && z === 0)
            addCenterSticker(cubelet, 0, 'CR.png', 180); // UR
          if (x === 1 && y === -1 && z === 0)
            addCenterSticker(cubelet, 0, 'CR.png', 0); // DR
          if (x === 1 && z === 1 && y === 0)
            addCenterSticker(cubelet, 0, 'CR.png', 270); // FR
          if (x === 1 && z === -1 && y === 0)
            addCenterSticker(cubelet, 0, 'CR.png', 90); // B
          // --- L* edges ---
          if (x === -1 && y === 1 && z === 0)
            addCenterSticker(cubelet, 1, 'CL.png', 180); // UL
          if (x === -1 && y === -1 && z === 0)
            addCenterSticker(cubelet, 1, 'CL.png', 0); // DL
          if (x === -1 && z === 1 && y === 0)
            addCenterSticker(cubelet, 1, 'CL.png', 90); // FL
          if (x === -1 && z === -1 && y === 0)
            addCenterSticker(cubelet, 1, 'CL.png', 270); // BL
        }
